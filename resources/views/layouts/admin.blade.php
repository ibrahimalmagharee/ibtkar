...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css-rtl/plugins/forms/wizard.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css-rtl/category.css')}}">
    <!-- END Custom CSS-->
